...
export function Header() {
  ...
  return (
    <header 
      className="fixed top-10 mx-[25px]     px-[10px] sm:mx-[45px]   lg:mx-[37px] xl:mx-auto xl:max-w-[1246px] rounded-full left-0 right-0 z-50 bg-[#F7F7F7] bg-opacity-80 backdrop-blur-sm "
      itemScope 
